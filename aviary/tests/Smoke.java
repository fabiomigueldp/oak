            ...
            try {
                ...
                if(player==null) {
                    ...
                    Connection connection=new Connection(PacketFlow.SERVERBOUND) {
                        ...
                        private void record(Packet<?> packet){packets.merge(packet.getClass().getSimpleName(),1,Integer::sum);}
                    };
                ...
                if(!app.journeys.containsKey(player.getUUID())&&!app.store.recoveries.containsKey(player.getUUID())) {
                    ...
                    if(player.isPassenger()||!player.getPostEffects().isEmpty()||Aviary.isTravelling(player.getUUID())||count(player.level())!=baseline)throw new AssertionError("Flight state leaked");
