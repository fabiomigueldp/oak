...
class ApiTests(unittest.TestCase):
    ...
    def test_places_schedules_and_freshness(self):
        ...
        self.assertEqual(self.post('/schedules', {'kind': 'backup', 'params': {'name': 'Automatic'}, 'interval_minutes': 60}).status_code, 400)
        schedule = self.post('/schedules', {'kind': 'save', 'params': {}, 'interval_minutes': 60})
